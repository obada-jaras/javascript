...
export const arSA: LocalizationResource = {
  ...
  formFieldError__verificationLinkExpired: 'صلاحية رمز التأكيد انتهت. يرجى طلب رابط جديد',
  ...
  formFieldLabel__automaticInvitations: 'تمكين الدعوة الأوتوماتكية لهذا النطاق',
  ...
  formFieldLabel__emailAddresses: 'عناوين البريد الإلكترونية',
  ...
  formFieldLabel__organizationDomainEmailAddressDescription:
    'أدخل عنوان بريد إلكتروني ضمن هذا النطاق لتلقي رمز والتحقق من هذا النطاق.',
  formFieldLabel__organizationName: 'الاسم',
  formFieldLabel__organizationSlug: undefined,
  ...
  maintenanceMode: 'نحن حالياً نقوم بأعمال صيانة، ولكن لا تقلق، لن تستغرق أكثر من بضع دقائق.',
  ...
  organizationList: {
    ...
    invitationAcceptedLabel: 'قمت بالانضمام',
    subtitle: 'للمتابعة إلى {{applicationName}}',
    suggestionsAcceptedLabel: 'موافقة معلقة',
    title: 'اختر حساب',
    titleWithoutPersonal: 'اختر مؤسسة',
  },
  organizationProfile: {
    badge__automaticInvitation: 'دعوات تلقائية',
    badge__automaticSuggestion: 'اقتراحات تلقائية',
    badge__manualInvitation: 'لا يوجد تسجيل تلقائي',
    badge__unverified: 'لم يتم التحقق',
    createDomainPage: {
      subtitle:
        'أضف النطاق للتحقق. يمكن للمستخدمين الذين لديهم عناوين بريد إلكتروني ضمن هذا النطاق الانضمام إلى المؤسسة تلقائيًا أو طلب الانضمام.',
      title: 'إضافة نطاق',
    },
    invitePage: {
      detailsTitle__inviteFailed: 'لم يتم إرسال الدعوات. توجد بالفعل دعوات معلقة لعناوين البريد الإلكتروني التالية: {{email_addresses}}.',
      formButtonPrimary__continue: 'إرسال الدعوات',
      selectDropdown__role: 'اختر دور',
      subtitle: 'أدخل أو الصق عنوان بريد إلكتروني واحد أو أكثر، مفصولة بمسافات أو فواصل.',
    ...
    membersPage: {
      ...
      invitationsTab: {
        autoInvitations: {
          headerSubtitle:
            'قم بدعوة المستخدمين عن طريق ربط نطاق بريد إلكتروني مع مؤسستك. أي شخص يقوم بالتسجيل باستخدام نطاق بريد إلكتروني مطابق سيتمكن من الانضمام إلى المؤسسة في أي وقت.',
          headerTitle: 'الدعوات التلقائية',
          primaryButton: 'إدارة النطاقات التي تم التحقق منها',
        },
        table__emptyRow: 'لا يوجد دعوات للعرض',
      },
      invitedMembersTab: {
      ...
      requestsTab: {
        autoSuggestions: {
          headerSubtitle:
            'المستخدمون الذين يسجلون باستخدام نطاق بريد إلكتروني مطابق سيتمكنون من رؤية اقتراح لطلب الانضمام إلى مؤسستك.',
    ...
    profilePage: {
      dangerSection: {
        deleteOrganization: {
          ...
          messageLine1: 'هل أنت متأكد من انك تريد حذف هذه المؤسسة؟',
        ...
        leaveOrganization: {
          ...
          messageLine1: 'هل أنت متاكد أنك تريد الخروج من هذه المؤسسة؟ سوف تفقد الوصول لهذه المنظمة وجميع تطبيقاتها',
          messageLine2: 'هذا القرار نهائي ولا يمكن التراجع عنه.',
      ...
      domainSection: {
        ...
        primaryButton: 'إِضافة نطاق',
        subtitle:
          'اسمح للمستخدمين بالانضمام إلى المؤسسة تلقائيًا أو طلب الانضمام بناءً على نطاق بريد إلكتروني تم التحقق منه.',
    ...
    removeDomainPage: {
      messageLine1: 'سيتم حذف نطاق البريد الإلكتروني {{domain}}.',
      messageLine2: 'لن يتمكن المستخدمون من الانضمام إلى المؤسسة تلقائيًا بعد ذلك.',
      successMessage: 'تم حذف النطاق {{domain}}.',
      title: 'حذف النطاق',
    },
    start: {
